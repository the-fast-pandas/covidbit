export const admin = `
    ...
    <div align="center" class="img-container center fixedwidth" style="padding-right: 20px;padding-left: 20px;">
        <div style="font-size:1px;line-height:20px">&nbsp;</div><img align="center" alt="Welcome" border="0" class="center fixedwidth" src="images/welcome-handshakers.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 325px; display: block;" title="Welcome" width="325">
