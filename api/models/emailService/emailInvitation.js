...
const emailInvitation = function (email, businessName) {
    ...
    const mailOptions = {
        ...
        to: email,
        subject: 'COVIDBIT Website Invitation',
        ...
        <div class="txtTinyMce-wrapper" style="line-height: 1.5; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: center; font-size: 12px; color: #393d47; mso-line-height-alt: 18px;"><span style="font-size: 30px;"><strong>Invitation to Register</strong></span></div>
        </div>
    
        <!-- center image -->
        <div align="center" class="img-container center fixedwidth" style="padding-right:20px;padding-left: 20px;">
            <div style="font-size:1px;line-height:20px">&nbsp;</div><img align="center" alt="Invite" border="0" class="center fixedwidth" src="cid:invitation" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 325px; display: block;" title="Invite" width="325">
            <div style="font-size:1px;line-height:20px">&nbsp;</div>
        </div>
    
        <div style="color:#393d47;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:1.5;padding-top:10px;padding-right:45px;padding-bottom:0px;padding-left:45px;">
        <div class="txtTinyMce-wrapper" style="line-height: 1.5; font-size: 12px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #393d47; mso-line-height-alt: 18px;">
        <p style="line-height: 1.5; word-break: break-word; text-align: left; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; mso-line-height-alt: 24px; margin: 0;">
            <span style="font-size: 16px;"><strong><span style="text-align: left; background-color: transparent;">Hello <span style="color: #aa67cf;">${businessName}</span>,</span></strong></span>
        </p>
        ...
        <p style="line-height: 1.5; word-break: break-word; text-align: left; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 13px; mso-line-height-alt: 24px; margin: 0;">
            <span style="font-size: 14x;">
                <span style="text-align: left; background-color: transparent;">
                    <span style="color: black;">
                    
                    This email is being sent to you on behalf of The Fast Pandas, 
                    a group of aspiring software developers from Seneca College.<br><br>
                    ...
                    It has had a particularly negative impact on local businesses. <br><br>
    
                    We have spent the last few months creating the COVIDBIT, 
                    that we hope will relieve some of the pressure put on businesses during this time.
                    This platform will provide you with the opportunity to advertise your businesses’ 
                    safety measures, track cases and be certified as a safe business. <br><br>
    
                   <strong> We have selected your business to join our web application. </strong><br><br>
    
                    We hope that our project will provide relief to your business so that you can 
                    continue to serve your community. <br><br>
    
                    You can register for our website using the link below:<br>
                     </span>
                </span>
            </span>
        </p>
        ...
        <div class="txtTinyMce-wrapper" style="line-height: 2; font-size: 13px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: left; color: #393d47; mso-line-height-alt: 18px;">
...
,
        attachments: [{
            ...
            path: __dirname + '/images/invitation.png',
            cid: 'invitation'
        },
        {
